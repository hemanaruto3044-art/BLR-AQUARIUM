      ...
      >
        <div className="relative aspect-square overflow-hidden bg-sky-900/50">
          ...
          <button
            ...
            className="absolute top-3 right-12 p-2 bg-black/30 backdrop-blur-md border border-white/10 text-white rounded-full opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all hover:bg-black/50 z-10"
            title="Quick View"
          >
